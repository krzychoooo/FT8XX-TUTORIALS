...
#ifndef _GD23Z_H_INCLUDED
#define _GD23Z_H_INCLUDED
...
// EEPROM.begin(512);
 ...
 #define SD_PIN      4
  ...
  #define SD_PIN      PA11 //SPI2   F767ZI
  
#define EEPROM_SOURCE      0  // 0 external, 1 DS3231 ZS-042

#if (EEPROM_SOURCE == 0)
 #define i2c_address 0x50    //EEPROM external
#endif
...
//Pantalla FT8XX
#define FreqSPI1          (21) // (21000000)=21MHz
#define FreqSP1           (21000000) // (36000000)=36MHz

//Lector externo en SPI2
#define FreqSPI2          (36)       // (36000000)=36MHz
#define FreqSD2           (36000000) // (36000000)=36MHz

//Lector externo en SPI3
#define FreqSPI3          (36)       // (36000000)=36MHz
#define FreqSD3           (36000000) // (36000000)=36MHz
...
#define LFFC         15     //5 cm (RndMnkIII),   15 cm (Riverdi)   longitud del cable de conexion 
  ...
  #define PROTO    0   //0 FT8xx,  1 MEGA UNO gameduino23
...
#if !defined(__DUE__) && !defined(ESP8266) && !defined(ARDUINO_ARCH_STM32L4) && !defined(ESP32) && !defined(ARDUINO_ARCH_STM32)
...
//FT81XMania: TFTLCDCyg
  ...
  //FT81XMANIA TEAM (RndMnkIII) método loadSDIO para carga de assets desde lector SDIO tarjetas Teensy 3.5/3.6
  byte loadSDIO(File& archivo, void (*progress)(long, long) = NULL);

  void safeload(const char *filename);

  //FT81XMANIA TEAM (RndMnkIII) método safeloadSDIO para carga de assets desde lector SDIO tarjetas Teensy 3.5/3.6
...
class Streamer {
public:
//FT81XMANIA TEAM (RndMnkIII) reemplazado valor 0x40000UL por FT_LIMITE_SUP_MEMORIA
  void begin(const char *rawsamples,
             uint16_t freq = 44100,
             byte format = ADPCM_SAMPLES,
             uint32_t _base = (FT_LIMITE_SUP_MEMORIA - 8192), uint16_t size = 8192) {
